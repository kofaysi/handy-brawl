...
cards = {1: (  # card 1
    ...
    {'A': (
        ...
        'B': (
            dict(life="healthy", reaction="shield", shield="rotate"),
    ...
    {"A": (
        ...
        "D": (
            dict(life="wounded", feature={"heavy"}, reaction="shield"),
    ...
    dict(name="huntress", type="hero"),
    {"A": (
        dict(life="healthy", reaction="dodge", dodge="rotate"),
        (("arrow", 1, "enemy"), ("rotate", None, "self"),),
        (("quicken", 2, "enemy"), ("maneuver", None, "ally"), ("rotate", None, "self"),),
    ...
    dict(name="vampire", type="monster"),
    {"A": (
        dict(life="healthy"),
        (),
        ()
    ...
    dict(name="pyromancer", type="hero"),
    {"A": (
        dict(life="healthy"),
        (),
        ()
    ...
    dict(name="werewolf", type="monster"),
    {"A": (
        dict(life="healthy"),
        (),
        ()
